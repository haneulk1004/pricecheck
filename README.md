...
성공 결과는 Upstash Redis에 24시간 저장합니다. 새 가격 조사는 기본 IP당 하루 5회, 전체 하루 300회이며 환경 설정으로 변경할 수 있습니다. 현재 Preview의 IP 한도는 10회입니다. 사용량은 한국시간 자정에 초기화됩니다. IP는 HMAC 해시로만 저장합니다.
