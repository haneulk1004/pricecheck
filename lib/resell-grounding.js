...
export function buildResellInteractionRequest(generateContentBody, input, model) {
  ...
  return {
    ...
    system_instruction: 'Use Google Search for current resale research. Enforce exact product, exact model code, and exact selected-size evidence. Reject headline/overall prices and other-size prices. Return only citation-backed offers; otherwise return no offers.',
